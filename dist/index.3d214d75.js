...
input.addEventListener("input", (0, _debounceDefault.default)(onInputChange, DEBOUNCE_DELAY));
function onInputChange() {
    searchCountryName = input.value.trim();
    if (searchCountryName === "") {
        clearAll();
        return;
    } else (0, _fetchCountriesJs.fetchCountries)(searchCountryName).then((countryNames)=>{
        if (countryNames.length < 2) {
            createCountrieCard(countryNames);
            (0, _notiflixDefault.default).Notify.success("Here your result");
        } else if (countryNames.length < 10 && countryNames.length > 1) {
            createCountrieList(countryNames);
            (0, _notiflixDefault.default).Notify.success("Here your results");
        } else {
            clearAll();
...
},{"lodash/debounce":"bv6vy","notiflix":"5z0Oc","./css/styles.css":"blubp","./fetchCountries.js":"crHiB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bv6vy":[function(require,module,exports) {
...
},{}],"blubp":[function() {},{}],"crHiB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}]},["dB9nQ","bB7Pu"], "bB7Pu", "parcelRequireabb0")
